...
export default function WhatsAppSchedulingPage() {
  ...
  useEffect(() => {
    const init = async () => {
      try {
        ...
        console.error("Failed to initialize WhatsApp scheduling page:", e)
      } finally {
        setLoading(false)
      }
    }
          ...
          <div className="flex gap-4">
            ...
            <Dialog open={isCreateCampaignOpen} onOpenChange={setIsCreateCampaignOpen}>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  <DialogTitle>Create New WhatsApp Campaign</DialogTitle>
                </DialogHeader>
